...
func TestEveryEndpointExceptLoginDeniesUnauthenticatedRequests(t *testing.T) {
	...
	routes := []struct{ method, path, body string }{
		...
		{http.MethodGet, "/admin/api/projects/atlas/files", ""},
		{http.MethodGet, "/admin/api/entries", ""},
		{http.MethodGet, "/admin/api/entries.csv", ""},
		...
		{http.MethodPost, "/admin/api/handoffs/1/messages", `{}`},
		{http.MethodPost, "/admin/api/handoff-messages/1/actions", `{}`},
		{http.MethodPost, "/admin/api/handoff-messages/1/files", ""},
		{http.MethodGet, "/admin/api/handoff-files/1", ""},
		{http.MethodDelete, "/admin/api/handoff-files/1", ""},
